...
import com.alone.blocky_seas.procedures.Ability2OnKeyPressedProcedure;
...
public class Ability2Message {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		BlockySeas.addNetworkMessage(Ability2Message.class, Ability2Message::buffer, Ability2Message::new, Ability2Message::handler);
	}
}
...
import com.alone.blocky_seas.procedures.OpenMenuOnKeyPressedProcedure;
...
public class OpenMenuMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		BlockySeas.addNetworkMessage(OpenMenuMessage.class, OpenMenuMessage::buffer, OpenMenuMessage::new, OpenMenuMessage::handler);
	}
}
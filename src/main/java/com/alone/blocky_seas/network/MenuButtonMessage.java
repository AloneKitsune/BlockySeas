...
import com.alone.blocky_seas.procedures.OpenAbilityMenuProcedure;
...
public class MenuButtonMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		BlockySeas.addNetworkMessage(MenuButtonMessage.class, MenuButtonMessage::buffer, MenuButtonMessage::new, MenuButtonMessage::handler);
	}
}